# AGENTS.md — Sovereign Router (`/home/toxic/projects/sovereign-router`)

**Role**: Multi-provider LLM routing gateway (OpenAI-compatible `/v1/chat/completions`) on port `:25100`.
**Stack**: Python (FastAPI/asyncio), TypeScript, proxy endpoints.
