...
// Configuration
// ──────────────────────────────────────────────────────────────
const PORT = parseInt(process.env.NIM_QUEUE_PORT ?? "25189", 10);
const UPSTREAM_BASE = process.env.NIM_QUEUE_UPSTREAM ?? "http://127.0.0.1:25100";
const UPSTREAM_HAS_V1 = UPSTREAM_BASE.endsWith("/v1");
const UPSTREAM = UPSTREAM_BASE; // alias for compatibility
const ADMIN = process.env.NIM_QUEUE_LLAMA_ADMIN ?? "http://127.0.0.1:25100";
