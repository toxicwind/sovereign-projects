...
const _HERD_BASE = LLAMA_SWAP_BASE; // alias for project-wide herd naming (tau: any pi/omp -> tau)
// ──────────────────────────────────────────────────────────────
...
const REASONING_ROUTES: Record<string, BackendSpec[]> = {
  ...
  low: [
    ...
    {
      model: "mradermacher/qwen3.5-9b-deepseek-v4-flash-i1-q4_k_s",
      fork: "beellama",
      context: 131072,
      quant: "IQ4_XS",
      vram: "~9GB",
    ...
    {
      model: "jackrong/qwen3.5-9b-deepseek-v4-flash-da-q4km",
      fork: "beellama",
      context: 131072,
      quant: "Q4_K_M",
      vram: "~9GB",
  ...
  medium: [
    ...
    {
      model: "mradermacher/qwen3.5-9b-deepseek-v4-flash-i1-q4_k_m",
      fork: "beellama",
      context: 131072,
      quant: "IQ4_XS",
      vram: "~9GB",
  ...
  high: [
    ...
    {
      model: "beellama/qwen3.5-9b-deepseek-v4-flash-da-q4km",
      fork: "beellama",
      context: 131072,
      quant: "Q4_K_M",
      vram: "~9GB",
  ...
  max: [
    ...
    {
      model: "turboquant/heretic-27b-128k",
      fork: "turboquant",
      context: 131072,
      quant: "Q5_K_XL",
      vram: "~16GB",
  ...
  xhigh: [
    ...
    {
      model: "turboquant/heretic-27b-256k",
      fork: "turboquant",
      context: 262144,
      quant: "Q5_K_XL",
      vram: "~18GB",
    ...
    {
      model: "ik_turboquant/heretic-27b-256k",
      fork: "ik_turboquant",
      context: 262144,
      quant: "Q5_K_XL",
      vram: "~18GB",
  ...
  if (preferredModel) {
    ...
    if (exactMatch) {
      return {
        ...
        backend: exactMatch,
        fallback_models: backends
          .filter((b) => b.model !== preferredModel)
          .map((b) => b.model),
  ...
  async fetch(req) {
    ...
    if (url.pathname === "/v1/route" && req.method === "POST") {
      try {
        ...
        let available = true;
        try {
          const modelsRes = await fetch(`${LLAMA_SWAP_BASE}/v1/models`, {
...
console.log(
  `[reasoning-router] listening :${server.port} → llama-swap=${LLAMA_SWAP_BASE}`,
);
console.log(
  `[reasoning-router] Routing tiers: ${Object.keys(REASONING_ROUTES).join(", ")}`,
);
