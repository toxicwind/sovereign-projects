...
# from https://github.com/NixOS/nix/blob/master/scripts/sequoia-nixbld-user-migration.sh
...
re_create_nixbld_user(){
	...
	sudo /usr/bin/dscl . -create "/Users/$name" "PrimaryGroupID" "$NIX_BUILD_GROUP_ID"
}
