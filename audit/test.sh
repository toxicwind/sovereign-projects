...
fixed_devenv = '''{ config, pkgs, lib, inputs, ... }:
...
output_path = "/mnt/agents/output/devenv_fixed.nix"
with open(output_path, "w") as f:
    f.write(fixed_devenv)

print(f"Fixed devenv.nix written to: {output_path}")
print(f"File size: {len(fixed_devenv)} chars")
