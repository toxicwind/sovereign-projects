...
* *Note: Verification shows both submodules are already checked out and initialized to the proper commits in the active workspace.*
...
```
*(Alternatively, for a manual pip workflow inside a standard venv:)*
```bash
