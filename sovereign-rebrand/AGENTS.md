# AGENTS.md — Sovereign Rebrand (`/home/toxic/projects/sovereign-rebrand`)

**Role**: Rebranding and migration tracking workspace for the Sovereign ecosystem transition.
**Stack**: Markdown, AST scripts, migration specs.
