...
| 1m-prober | Long-context engagement probe (oracle verdict 12097, mission 4e621a18): needle-in-haystack retrieval at 100k/500k/1M tokens through the nvidia keyed lane (nemotron-3-super-120b-a12b, nemotron-3-nano-omni-30b-a3b-reasoning) and the openrouter :free nemotron ID; results recorded in ast_matrix.db requests (strategy=longctx-probe); probe script tools/sovereign-router/probes/long-context-probe.py | 1m-prober (Ember crew, worker under coordinator 4e621a18) | RUNNING (2026-09-21) |
