...
| lane-oracle-connector | Oracle intake front-door wiring + yote-connector canonicalization (retire non-canonical exec paths, canonical source tracking) | lane-oracle-connector (Ember's crew) | RUNNING (2026-09-20) |
