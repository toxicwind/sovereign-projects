...
| vesper | Identity lane: pack roster + per-persona folders (docs/fleet/personas/); transcript verification of Chris's orders (message_id-grounded); keeps the who's-who straight as crews join. | Vesper (Ember's crew) | RUNNING (2026-09-21) |
...
| tau-router-recon | TAU/oh-my-pi routing-extension recon: map canonical omp-model-router vs stale/dead duplicates, model-selection logic with exact file/line refs, exact benchmark invocation vs Sovereign Router :25104 model sovereign/free | tau-router-recon (Ember's crew) | RUNNING (2026-09-21) |
