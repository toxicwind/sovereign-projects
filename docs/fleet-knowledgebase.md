...
| taps-nats | NATS + JetStream fleet-chat substrate (Ember decider verdict fleet 12811): nats-server 2.14.5 + JetStream on yote (4222/4223/8222, funnel /nats-ws), file->NATS tailer (inotify, cursor, Nats-Msg-Id dedup, presence KV), ui.html ?src=nats + poll/nats toggle, E2E 8/8 (dual-sink seq agreement, NATS-kill catch-up, restart replay) | Taps (Ember's crew) | DONE (2026-09-21) -- remote main abb4a283, daemons nats + nats-tail live |
