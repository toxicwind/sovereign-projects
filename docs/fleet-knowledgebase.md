...
| lumen-md-race | Squawk markdown lane finish: kill stale test_text_truncated_at_500 (replaced by untruncated-body test), fix stale 500-char doc mentions, harden rapid channel-switch vs stale render (AbortController), verify >500-char markdown live end to end, push, fleet markdown-conventions broadcast | Lumen (Ember crew) | RUNNING |
