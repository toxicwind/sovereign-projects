...
15. **Oracle stands in for Chris's approvals.** The pack works together autonomously via squawk; when a decision needs Chris's approval (go/no-go, upgrade petitions, risky-but-reversible calls), do NOT wait on him — frame it as a dated yes/no oracle question with evidence and treat the verdict as his approval, final. Reserve direct pings to Chris for money, credentials he must mint/rotate, and irreversible actions outside standing boundaries: the oracle cannot approve spending, top-ups, credential minting/rotation, or any credential-shaped action.
