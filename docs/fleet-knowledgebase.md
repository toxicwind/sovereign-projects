...
| estate-reconcile-watch-reg | Register estate-reconcile watch as a Pitchfork daemon (WS2 gap close): durable [daemons.estate-reconcile-watch] in pitchfork.toml, restart-tested | register-pitchfork | RUNNING (2026-09-21) |
