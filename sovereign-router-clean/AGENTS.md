# AGENTS.md — Sovereign Router Clean (`/home/toxic/projects/sovereign-router-clean`)

**Role**: Clean reference implementation of the Sovereign LLM routing gateway.
...
- High-frequency probes, dynamic env var interpolation, minimal dependencies.
