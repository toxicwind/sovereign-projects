...
download "StrangeMerges_19-7B-dare_ties.Q4_K_M.gguf" "internlm/StrangeMerges_19-7B-dare_ties-GGUF" "*Q4_K_M*.gguf" || log "StrangeMerges local only - skip if not on HF"
