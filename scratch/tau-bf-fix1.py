#!/usr/bin/env python3
"""Tau bruteforce fix batch 1: gix API adaptations, pi-iso additions."""
import sys
...
old = """pub(crate) fn normalize_path(path: &Path) -> PathBuf {"""
new = """/// Write a commit object without updating any reference.
///
