...
Core logic is unit-tested at 100% coverage — `bun run test:gateway:cov` (23 tests, verified 2026-09-14). Self-serve: `GET /health`.
...
bun run test:gateway:cov     # MCP gateway core: 100% coverage (23 tests)
