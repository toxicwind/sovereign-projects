...
| `hatch/connector.py` | Canonical source of the cell-side yote-connector daemon (127.0.0.1:18301). v2.0 adds `POST /exec-multi`, `POST /exec-bg`, `GET /bg`, `GET /bg/<handle>`. |
| `hatch/yote-conn` | Canonical source of the CLI. Adds `multi`, `bg`, `bg-status`, `bg-list`. |
