...
```sh
# from the tau tree (extensions workspace)
cd /home/toxic/sovereign/projects/tau/extensions
bun install
```
...
ln -s /home/toxic/sovereign/projects/tau/extensions/kimi ~/.tau/agent/extensions/omp-kimi
```
