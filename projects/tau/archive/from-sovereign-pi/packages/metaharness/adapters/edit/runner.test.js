...
import { buildBenchmarkResult, writeConversationDump } from "./runner";
const tempDirs = [];
...
function createRun(runIndex, success, overrides = {}) {
    return {
        runIndex,
        success,
...
describe("buildBenchmarkResult", () => {
    ...
    it("reports median, p1, and p99 token stats across best runs", () => {
        ...
        const resultsByTask = new Map(totals.map((total, i) => [
            tasks[i].id,
