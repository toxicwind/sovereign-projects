...
import { createTauPromptHarness, TauPromptHarness } from '@moonshot-ai/tau-bridge';
import { createKimiCodeHostIdentity } from './version';
...
async function createPromptHarness(
  ...
  // MAXIMAL: Use tau bridge (oh-my-pi engine) instead of legacy KimiHarness
  return createTauPromptHarness(options as any);
}
