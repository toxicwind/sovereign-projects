...
<!-- Tau Engine - sovereign orchestration service: resolve these three facts from real evidence and delete this
...
RALPH-FACT: supported_platforms: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: shell_dialect: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: script_directory: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: set the project's real gate-script lint command. The first
