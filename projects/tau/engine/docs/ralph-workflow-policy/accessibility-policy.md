...
<!-- Tau Engine - sovereign orchestration service: record the standard, supported input modes, review process,
...
RALPH-FACT: conformance_level_and_platform_scope: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: keyboard_and_focus_pattern: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: assistive_technology_review: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: material_flow_and_platform_at_matrix: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: applicability_decision: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: declare the real accessibility gate, then delete this comment. -->
