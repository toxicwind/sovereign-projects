...
RALPH-FACT: linter_per_language: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: rule_set_baseline: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: formatter_responsibility: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: excluded_paths: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suppression_rationale_policy: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: ci_gate_integration: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: maintenance_evidence: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: first_party_languages: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: excluded_language_evidence: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: dead_code_detection_per_language: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: retained_compatibility_inventory: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: live_entry_point_annotation_inventory: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: per-language template. Keep one block per maintained first-party language
...
RALPH-LANG: Python
RALPH-COMMAND: cargo check --workspace
...
RALPH-INAPPLICABLE: TypeScript project, no JS typechecking needed
