...
<!-- Tau Engine - sovereign orchestration service: record verified paths and rules; for an unsettled fact record
the current decision and its review trigger, then delete this comment. -->

RALPH-FACT: architecture_style: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: component_map: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: dependency_direction: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: forbidden_dependencies: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: state_ownership: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: external_io_boundaries: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: durable_contracts: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: decision_record_location: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: quality_attribute_scenarios: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: runtime_and_deployment_views: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: major_data_flows: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: known_risks_and_tradeoffs: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: conformance_method: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: declare an executable architecture/import/contract command
