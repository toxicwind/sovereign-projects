...
<!-- Tau Engine - sovereign orchestration service: record one verified, machine-checkable value per fact
...
2026-09-13); review trigger: <trigger>" — it reaches readiness and a dev-cycle
...
RALPH-FACT: test_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: test_command_prerequisites: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: primary_test_framework: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: secondary_test_frameworks: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: test_isolation_strategy: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: io_mocking_approach: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suite_time_budget: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: per_test_timeout: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: timeout_enforcement_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: parallel_execution_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: slow_test_report_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suite_test_count_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: assertion_quality_check: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: supported_platform_matrix: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: external_dependency_test_approach: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: clean_clone_setup_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: flake_policy: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: quarantine_mechanism_expiry_and_max_size: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suite_review_cadence_and_owner: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: regression_test_convention: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: set the project's real gate command. The first token must
...
RALPH-PENDING deferral — `RALPH-PENDING: <approved-tool> (assumed 2026-09-13);
