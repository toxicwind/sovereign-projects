...
RALPH-FACT: user_docs_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: operator_docs_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: contributor_docs_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: api_reference_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: architecture_docs_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: release_notes_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: docstring_convention: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: example_verification_command: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: the RALPH-COMMAND gate covers only the mechanically
