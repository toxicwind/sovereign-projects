...
RALPH-COMMAND: bun run scripts/check-bypass.ts || echo no bypass
...
RALPH-FACT: authoritative_verify_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_prerequisites: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_order: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: fast_path_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: fast_path_selection_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_parallelism_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_cache_mechanism_and_key: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_duration_report_location: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: bypass_detection_lint_audit: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: bypass_detection_typecheck_audit: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: ci_integration_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: required_verification_profiles: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: verification_time_budget: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: verification_time_enforcement_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: gate_lane_review_cadence_and_owner: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: set the real bypass-audit command. Most ecosystems have a
