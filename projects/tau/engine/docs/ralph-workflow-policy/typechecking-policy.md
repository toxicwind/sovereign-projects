...
RALPH-FACT: typechecker_per_language: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: strictness_level: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: excluded_paths: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: stubbed_dependencies: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suppression_rationale_policy: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: suppression_inventory_and_baseline: Tau Engine orchestrates pitchfork services via mise tasks
...
RALPH-FACT: type_modeling_conventions: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: sanctioned_dynamic_boundaries: Tau Engine orchestrates pitchfork services via mise tasks
