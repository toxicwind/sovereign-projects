...
export function Shell() {
    ...
    const viewDisplay = (v) => (activeView() === v ? "" : "none");
    return (<div class="rmp-app">
      ...
      <Show when={drawerOpen()}>
        <div class="rmp-mobile-drawer-overlay" onClick={() => setDrawerOpen(false)} role="presentation">
          <div class="rmp-mobile-drawer" onClick={(e) => e.stopPropagation()} role="dialog" aria-modal="true" aria-label="Navigation menu">
            <Rail />
          </div>
        </div>
      </Show>
