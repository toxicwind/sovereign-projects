...
import { DEFAULT_OAUTH_REFRESH_TIMEOUT_MS, MAX_PENDING_DISABLED_EVENTS, OAUTH_REFRESH_FAILURE_BACKOFF_MS, OAUTH_REFRESH_LEASE_POLL_MS, OAUTH_REFRESH_LEASE_RENEW_MS, OAUTH_REFRESH_LEASE_TTL_MS, OAUTH_REFRESH_OPERATION_TIMEOUT_MS, OAUTH_REFRESH_SKEW_MS, isAbortSignalOption } from "./auth/oauth-refresh-support";
import type { AuthApiKeyOptions, InvalidateCredentialMatchingOptions, OAuthAccess, OAuthAccessResolution, OAuthAccountIdentity, OAuthAccountSummary, OAuthLoginIdentity, OAuthResolutionResult, ResetCreditAccountStatus, ResetCreditRedeemOutcome, ResetCreditTarget, StoredOAuthRefreshOptions, StoredOAuthRefreshResult } from "./auth/oauth-refresh-support";
import { REMOTE_REFRESH_SENTINEL } from "./auth/storage-contract";
import type { ApiKeyCredential, AuthCredential, AuthCredentialEntry, AuthCredentialSnapshot, AuthCredentialSnapshotEntry, AuthCredentialStore, AuthStorageData, AuthStorageOptions, CheckCredentialsOptions, CompletionProbeCredential, CredentialDisabledEvent, CredentialHealthResult, CredentialOrigin, DisabledCredentialSummary, OAuthCredential, SnapshotCredential, StoredAuthCredential, StoredCredentialBlock } from "./auth/storage-contract";
import { AuthStorageUsageCache, DEFAULT_USAGE_REQUEST_TIMEOUT_MS, USAGE_FAILURE_BACKOFF_MS, USAGE_FORCE_REFRESH_CACHE_PREFIX, USAGE_FORCE_REFRESH_TTL_MS, USAGE_HEADER_INGEST_INTERVAL_MS, USAGE_REPORT_CACHE_KEY_VERSION_OVERRIDES, authCredentialEquals, raceCredentialRefreshWithSignal, raceUsageWithSignal, storedCredentialArraysEqual } from "./auth/usage-cache-impl";
import { DEFAULT_USAGE_PROVIDERS, compareUsageRankingMetric, credentialBlockScopesForRequest, getOpenAICodexPlanEligibility, getOpenAICodexPlanPriority, isDefinitiveOAuthFailure, modelAccountPolicyBlockScope, resolveDefaultRankingStrategy, resolveDefaultUsageProvider, resolveOpenAICodexPlanRequirement } from "./auth/usage-metrics";
import type { ForcedUsageRefresh, ModelUsageAccountHealth, ModelUsageHealth, ModelUsageHealthOptions, OpenAICodexPlanRequirement, UsageCache, UsageLimitMarkResult, UsageRequestDescriptor } from "./auth/usage-metrics";

// Re-exports of the extracted modules above (public surface unchanged).
export type { ApiKeyCredential } from "./auth/storage-contract";
export type { AuthCredential } from "./auth/storage-contract";
export type { AuthCredentialEntry } from "./auth/storage-contract";
export type { AuthCredentialSnapshot } from "./auth/storage-contract";
export type { AuthCredentialSnapshotEntry } from "./auth/storage-contract";
export type { AuthCredentialStore } from "./auth/storage-contract";
export type { AuthStorageData } from "./auth/storage-contract";
export type { AuthStorageOptions } from "./auth/storage-contract";
export type { CheckCredentialsOptions } from "./auth/storage-contract";
export type { CompletionProbe } from "./auth/storage-contract";
export type { CompletionProbeCredential } from "./auth/storage-contract";
export type { CompletionProbeInput } from "./auth/storage-contract";
export type { CredentialCompletionResult } from "./auth/storage-contract";
export type { CredentialDisabledEvent } from "./auth/storage-contract";
export type { CredentialHealthResult } from "./auth/storage-contract";
export type { CredentialOrigin } from "./auth/storage-contract";
export type { CredentialOriginKind } from "./auth/storage-contract";
export type { CredentialRefreshLeaseFence } from "./auth/storage-contract";
export type { DisabledCredentialSummary } from "./auth/storage-contract";
export type { OAuthCredential } from "./auth/storage-contract";
export { REMOTE_REFRESH_SENTINEL } from "./auth/storage-contract";
export type { RemoteOAuthCredential } from "./auth/storage-contract";
export type { RemoteRefreshSentinel } from "./auth/storage-contract";
export type { SerializedAuthStorage } from "./auth/storage-contract";
export type { SnapshotCredential } from "./auth/storage-contract";
export type { StoredAuthCredential } from "./auth/storage-contract";
export type { StoredCredentialBlock } from "./auth/storage-contract";
export type { ModelUsageAccountHealth } from "./auth/usage-metrics";
export type { ModelUsageHealth } from "./auth/usage-metrics";
export type { ModelUsageHealthOptions } from "./auth/usage-metrics";
export type { ModelUsageHealthState } from "./auth/usage-metrics";
export type { UsageLimitMarkResult } from "./auth/usage-metrics";
export { isDefinitiveOAuthFailure } from "./auth/usage-metrics";
export type { InvalidateCredentialMatchingOptions } from "./auth/oauth-refresh-support";
export type { OAuthAccess } from "./auth/oauth-refresh-support";
export type { OAuthAccessFailure } from "./auth/oauth-refresh-support";
export type { OAuthAccessResolution } from "./auth/oauth-refresh-support";
export type { OAuthAccountIdentity } from "./auth/oauth-refresh-support";
export type { OAuthAccountSummary } from "./auth/oauth-refresh-support";
export type { OAuthLoginIdentity } from "./auth/oauth-refresh-support";
export type { ResetCreditAccountStatus } from "./auth/oauth-refresh-support";
export type { ResetCreditRedeemOutcome } from "./auth/oauth-refresh-support";
export type { ResetCreditTarget } from "./auth/oauth-refresh-support";
export type { StoredOAuthRefreshOptions } from "./auth/oauth-refresh-support";
export type { StoredOAuthRefreshResult } from "./auth/oauth-refresh-support";
