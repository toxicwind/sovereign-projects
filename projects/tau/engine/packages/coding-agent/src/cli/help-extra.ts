...
export function getExtraHelpText(): string {
  ...
  Use \`tau --profile <name> --alias <command>\` to create a shell shortcut for a profile
...
${chalk.bold("Useful Commands:")}
  tau agents unpack           - Export bundled subagents to ~/.tau/agent/agents (default)
  tau agents unpack --project - Export bundled subagents to ./.tau/agents`;
}
