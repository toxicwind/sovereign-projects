...
Proven 2026-09-21: the free route then served a 1.2B local model whose
extractions were unreliable (inverted facts, hallucinated endpoints,
fabricated a `[C0126]` citation the provenance map correctly flagged as
dangling). The architecture is model-agnostic; proof runs use a capable
worker.
