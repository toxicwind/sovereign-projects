...
---
Side-chat watchdog for "Agent 2" (chat_id: 0fcb5f23-25d7-44de-9a7d-76342c7b4dd8).
...
1. Resolve the chat's root agent (a side chat's chat_id equals its agent's session_id):
   ...
   WHERE session_id = '0fcb5f23-25d7-44de-9a7d-76342c7b4dd8' AND kind = 'root'
...
2. Read the agent's latest turns (bounded, index-backed). Do NOT put a
   ...
   summary anyway (e.g. "agent2 watch <timestamp>: 0 recent turns, nothing to
