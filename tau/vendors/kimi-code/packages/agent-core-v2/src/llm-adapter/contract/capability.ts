import type { ModelCapability as LlmModelCapability } from '#human/llm/capability';
...
export function toLlmCapability(capability: ModelCapability): LlmModelCapability {
  return {
