...
export async function buildSystemPrompt(options: BuildSystemPromptOptions = {}): Promise<BuildSystemPromptResult> {
	...
	const bundledPersonality = (personality && personality !== "none" && (personality in PERSONALITY_SPECS)) ? (PERSONALITY_SPECS[personality as keyof typeof PERSONALITY_SPECS]?.trim() ?? "") : "";
