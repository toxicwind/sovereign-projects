...
<!-- Tau Engine - sovereign orchestration service: evaluate every surface in the catalog below against the
...
RALPH-FACT: active_threat_surfaces: Tau Engine orchestrates pitchfork services via mise tasks
...
RALPH-FACT: data_sensitivity (owner-supplied): Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: deployment_exposure (owner-supplied): Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: secrets_management_mechanism: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: secret_scan_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: security_scanner_per_language: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: finding_waiver_convention: Tau Engine orchestrates pitchfork services via mise tasks
...
<!-- Tau Engine - sovereign orchestration service: set the project's real secret-scan command (e.g. gitleaks
...
<!-- Tau Engine - sovereign orchestration service: per-language template. Keep one block per project language
...
RALPH-PENDING line (approved tool + `(assumed 2026-09-13)` + `review
