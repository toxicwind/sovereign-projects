...
RALPH-FACT: package_manager: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: lockfile_path: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: license_allowlist: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: security_audit_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: type_info_policy: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: ci_install_command: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: dependency_evaluation_record: Tau Engine orchestrates pitchfork services via mise tasks
RALPH-FACT: transitive_dependency_policy: Tau Engine orchestrates pitchfork services via mise tasks
...
`RALPH-PENDING: <approved-tool> (assumed 2026-09-13); review trigger: <trigger>`
