...
export function Pipeline() {
    ...
    return (<Show when={statusResource() !== undefined} fallback={<PipelineSkeleton />}>
...
function PipelineSkeleton() {
    return (<div class="rmp-card-grid">
...
function PipelineEmpty() {
    const allowlist = () => statusResource()?.runtime.repo_allowlist ?? [];
    return (<div class="rmp-pipeline-empty">
