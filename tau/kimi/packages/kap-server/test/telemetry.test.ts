...
describe('server telemetry', () => {
  ...
  it('attaches the cloud appender when config sets telemetry = true and persists the device id', async () => {
  ...
  it('keeps the null appender by default (SOVEREIGN PATCH: opt-in)', async () => {
